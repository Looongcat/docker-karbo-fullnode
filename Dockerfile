...
WORKDIR /home/karbo
RUN wget https://github.com/seredat/karbowanec/releases/download/v.1.5.5/karbowanec-xenial-1.5.5_linux_x86_64.zip &&\
	unzip karbowanec-xenial-1.5.5_linux_x86_64.zip &&\
	rm karbowanec-xenial-1.5.5_linux_x86_64.zip &&\
	mv ./karbowanec-xenial-1.5.5_linux_x86_64/karbowanecd /usr/bin/karbowanecd &&\
	mv ./karbowanec-xenial-1.5.5_linux_x86_64/walletd /usr/bin/walletd &&\
	mv ./karbowanec-xenial-1.5.5_linux_x86_64/simplewallet /usr/bin/simplewallet &&\
	chmod +x /usr/bin/karbowanecd /usr/bin/walletd /usr/bin/simplewallet &&\
	rm -rf ./karbowanec-xenial-1.5.5_linux_x86_64
