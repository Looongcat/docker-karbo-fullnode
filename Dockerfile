...
WORKDIR /home/karbo
RUN wget https://github.com/seredat/karbowanec/releases/download/v.1.6.3/karbo-cli-v1.6.3-64bit.tar.gz &&\
	tar -xzvf karbo-cli-v1.6.3-64bit.tar.gz &&\
	rm karbo-cli-v1.6.3-64bit.tar.gz &&\
	rm Readme.txt &&\
